...
import 'package:ecommerce/services/auth.dart';
import 'package:ecommerce/services/shared/constants.dart';
import 'package:ecommerce/services/shared/loading.dart';
import 'package:flutter/material.dart';
...
//            child: Center(
       ...
       child: SingleChildScrollView(//this helps remove the keyboard bottom pixel error
                ...
                TextFormField(
                  ...
                  decoration:InputDecoration(
                                 ...
                                 icon: Icon(Icons.location_city),
                                   border: InputBorder.none, ),
              obscureText: false,
              validator: (val) =>val.length<6 ?'enter your home town' :null ,
              onChanged: (val) {
                setState(() => homeLocation = val);
                 ...
                 Padding(
                  ...
                  onPressed: () async {
                    if (_formKey.currentState.validate()) {
                      ...
                      dynamic result = await _auth.registerWithEmailAndPassword(email, password,name,phone,homeLocation);
                      if( result == null) {
                        setState(() {
